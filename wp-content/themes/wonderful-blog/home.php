...
get_header();
$archive_page_title    = get_theme_mod( 'wonderful_blog_archive_page_title', '' );
$archive_page_subtitle = get_theme_mod( 'wonderful_blog_archive_page_subtitle', '' );
?>
...
<main id="primary" class="site-main">
	...
	<?php if ( have_posts() ) : ?>
		...
		<?php if ( wonderful_blog_is_frontpage_blog() ) { ?>
			...
			<?php
			$breadcrumb_enable = get_theme_mod( 'wonderful_blog_breadcrumb_enable', true );
			if ( $breadcrumb_enable ) :
				?>
				<div id="breadcrumb-list">
					<?php
					echo wonderful_blog_breadcrumb(
						array(
							'show_on_front' => false,
							'show_browse'   => false,
						)
		...
		<div class="theme-archive-layout list-layout list-style-1">
			...
			if ( $totalPosts > $postsPerPage ) {
				...
				$loadmore        = get_theme_mod( 'wonderful_blog_loadmore_text_label', __( 'Load More', 'wonderful-blog' ) );
