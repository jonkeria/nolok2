...
(function( $, api ) {
    wp.customize.bind('ready', function() {
        ...
        jQuery('.wonderful-blog-edit').click(function(e) {
            e.preventDefault();
            var jump_to = jQuery(this).attr( 'data-jump' );
            wp.customize.section( jump_to ).focus()
        });

        $('#sub-accordion-section-wonderful_blog_topbar').css( 'display', 'none' );
    });
})( jQuery, wp.customize );
...
(function(api) {
    ...
    function wonderful_blog_homepage_scroll(item, index) {
        ...
        wp.customize.section('wonderful_blog_' + item + '_section', function(section) {
