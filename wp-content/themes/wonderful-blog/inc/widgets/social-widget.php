...
if ( ! class_exists( 'Wonderful_Blog_Social_Widget' ) ) {
	/**
	 * Adds Wonderful Blog Social Widget.
	 */
	class Wonderful_Blog_Social_Widget extends WP_Widget {
		...
		public function __construct() {
			$wonderful_blog_social_widget = array(
				...
				'description' => __( 'Retrive Social Widget', 'wonderful-blog' ),
			);
			parent::__construct(
				'wonderful_blog_social_widget',
				__( 'Adore Widget: Social Widget', 'wonderful-blog' ),
				$wonderful_blog_social_widget
			);
		}
		...
		public function form( $instance ) {
			...
			for ( $i = 1; $i <= 4; $i++ ) {
				...
				?>
				<p>
					<label for="<?php echo esc_attr( $this->get_field_id( 'link' . '-' . $i ) ); ?>"><?php echo sprintf( esc_html__( 'Link %d :', 'wonderful-blog' ), $i ); ?></label>
