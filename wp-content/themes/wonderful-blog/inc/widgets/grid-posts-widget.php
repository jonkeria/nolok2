<?php
if ( ! class_exists( 'Wonderful_Blog_Grid_Posts_Widget' ) ) {
	/**
	 * Adds Wonderful Blog Grid Posts Widget.
	 */
	class Wonderful_Blog_Grid_Posts_Widget extends WP_Widget {
		...
		public function __construct() {
			...
			parent::__construct(
				'wonderful_blog_grid_posts_widget',
				__( 'Adore Widget: Grid Posts Widget', 'wonderful-blog' ),
				$grid_posts_widget
			);
		}
