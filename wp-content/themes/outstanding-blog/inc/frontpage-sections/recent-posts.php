...
$recent_posts_section = get_theme_mod( 'outstanding_blog_recent_posts_section_enable', false );
...
$recent_posts_content_type = get_theme_mod( 'outstanding_blog_recent_posts_content_type', 'post' );

if ( $recent_posts_content_type === 'post' ) {

	for ( $i = 1; $i <= 4; $i++ ) {
		$content_ids[] = get_theme_mod( 'outstanding_blog_recent_posts_post_' . $i );
	}
	...
	$cat_content_id = get_theme_mod( 'outstanding_blog_recent_posts_category' );
	$args           = array(
		'cat'            => $cat_content_id,
		'posts_per_page' => absint( 4 ),
	);
...
if ( $query->have_posts() ) {
	?>
	<div id="outstanding_blog_recent_posts_section" class="frontpage recentpost recent-style-2">
							...
							<div class="post-item-content">
								...
								<ul class="entry-meta">
									...
									<li class="reading-time"><i class="far fa-hourglass"></i>
										...
										echo esc_html__( ' min', 'outstanding-blog' );
										?>
									</li>
								</ul>
							</div>   
